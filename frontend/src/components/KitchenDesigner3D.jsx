...
const ALVIC_COLORS = [
  ...
  { group: 'ALVIC · Luxe (alto brillo)', label: 'Luxe Azul Índigo', bg: 'linear-gradient(135deg,#414b5e,#2d3544)' },
  ...
  { group: 'ALVIC · Zenit (supermate)', label: 'Zenit Azul Índigo SM', bg: '#414b5e' },
  ...
  { group: 'ALVIC · Zenit (supermate)', label: 'Zenit Picasso 01 SM', bg: 'linear-gradient(135deg,#aea79d,#8a8379)' },
  { group: 'ALVIC · Zenit (supermate)', label: 'Zenit Picasso 02 SM', bg: 'linear-gradient(135deg,#8a8379,#6b655d)' },
  ...
  { group: 'ALVIC · Syncron (madera)', label: 'Syncron Velázquez 01', bg: 'linear-gradient(135deg,#c4b8a1,#9e9178)' },
  { group: 'ALVIC · Syncron (madera)', label: 'Syncron Velázquez 02', bg: 'linear-gradient(135deg,#baae99,#93826d)' },
