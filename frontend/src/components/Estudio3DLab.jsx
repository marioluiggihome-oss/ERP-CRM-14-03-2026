...
export default function Estudio3DLab({ state, setState }) {
  ...
  // La tabla vive en `frontend/src/costeDeRender.js`, no aquí: desde el
  // 09/09/2026 hay DOS pantallas que renderizan (esta y el clon de pruebas) y
  // una tabla copiada en las dos se separa el día que se añada un motor.
  const creditosPorRender = () => creditosDeUnRender(providerOf());
