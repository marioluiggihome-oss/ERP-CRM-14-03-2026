...
const Armarios = ({ state, setState }) => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-slate-50 overflow-hidden">
      {/* Header — `hueco-logo` le deja sitio al botón/logo flotante del menú */}
      <div className="hueco-logo bg-white/90 backdrop-blur border-b border-slate-200 text-slate-900 px-4 py-3 flex items-center justify-between">
