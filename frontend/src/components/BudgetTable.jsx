          ...
          {items.length === 0 ? (
            ...
            <div id="budget-pdf" className="w-[210mm] mx-auto bg-white shadow-2xl p-[10mm] min-h-[297mm] flex flex-col rounded-sm border-t-[8px] border-indigo-950">
               ...
               <div className="flex-1">
                  <div className="grid grid-cols-16 gap-1 px-4 py-2 bg-indigo-950 text-white rounded-t-lg text-[6px] font-black uppercase tracking-widest italic items-center">
                  ...
                  {sortedItems.map((item) => {
                    ...
                    return (
                      <div key={item.id} className={`grid grid-cols-16 gap-1 px-4 py-2.5 items-center text-indigo-950 hover:bg-indigo-50/50 transition-colors ${isUnknown ? 'bg-red-50 border-l-4 border-red-500' : item.isManual ? 'bg-indigo-50/30' : specialCuts.length > 0 ? 'bg-orange-50/10' : ''}`}>
