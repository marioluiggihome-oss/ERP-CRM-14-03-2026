    ...
    async def generate_render(
        ...
        if ref_b64 and is_sketch:
            ...
            task_prompt = (
                ...
                "  · 'Columna' / '70': render a tall larder/pantry cupboard column.\n"
                ...
                "  · Drawer lines (gavetero): where horizontal drawer lines are drawn (e.g. under the cooktop), render distinct wide pull-out drawers with handleless gola channels.\n"
