    ...
    async def generate_render(
        ...
        if ref_b64 and is_sketch:
            ...
            task_prompt = (
                ...
                "- NO DIMENSIONS OR TEXT IN THE IMAGE: strictly FORBIDDEN to draw measurement lines, dimension arrows, numbers (e.g. '394 cm', '60 cm', '203 cm'), labels or annotations anywhere on the floor, walls or image. The floor and walls must be completely clean architectural surfaces.\n"
                ...
                "  · 'Micro / Horno' (Negro): tall column tower with built-in black electric oven and built-in black microwave directly above it.\n"
                "  · 'Combi 203' / 'Frigo Combi' (Negro): 60cm wide, 203cm tall black stainless steel / black glass freestanding combi refrigerator with top matching overhead cabinet (altillo).\n"
                "  · 'Columna' / '70' (Despensero): tall storage cupboard column; if dividing lines (cross lines) are drawn, render the EXACT door split shown (e.g. 4 doors: 2 upper doors side-by-side and 2 lower doors side-by-side).\n"
