    ...
    async def generate_render(
        ...
        if ref_b64 and is_sketch:
            ...
            task_prompt = (
                ...
                "- THREE DISTINCT TALL COLUMNS: when 3 tall columns are drawn on the right, render THREE CLEARLY SEPARATED units: 1) Oven + Microwave Tower, 2) Distinct Combi Refrigerator (stainless steel or combi split doors with top altillo), and 3) 4-Door Tall Pantry Column on the far right. Never blend the fridge into a flat blank cupboard.\n"
