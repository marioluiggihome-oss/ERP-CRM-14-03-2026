...
# MongoDB connection — usa el singleton compartido (services/db_client.py)
# para no abrir un pool adicional. Las variables client y db se mantienen
# para compatibilidad con los módulos que hacen `from server import db`.
...
api_router.include_router(kitchen_projects_router)
