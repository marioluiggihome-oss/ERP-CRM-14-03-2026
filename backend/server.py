...
@api_router.get("/montadores/{montador_id}")
...
@api_router.put("/montadores/{montador_id}")
...
@api_router.delete("/montadores/{montador_id}")
...
@api_router.get("/montajes/{montaje_id}")
...
@api_router.put("/montajes/{montaje_id}")
...
@api_router.delete("/montajes/{montaje_id}")
...
@api_router.get("/montadores/{montador_id}/montajes")
