#!/usr/bin/env python3
"""
Batch catalog import script for LUIGGI HOME - Pages 401-469
...
PDF_PAGES_DIR = '/app/pdf_pages_401_469'
...
- reference: Código de referencia completo (ej: "G8A1P350", "G11SC1P469")
...
async def main():
    ...
    # Check arguments
    if len(sys.argv) < 3:
        print("Uso: python import_pages_401_469.py <start_page> <end_page>")
        print("Ejemplo: python import_pages_401_469.py 401 310")
        return
    ...
    # Validate range
    if start_page < 401 or end_page > 469:
        print("Error: Las páginas deben estar entre 401 y 469")
        return
